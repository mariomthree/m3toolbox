<?php
/**
 * This widgets display a facebook page of website
 *
 * @package toolbox
 *
 */
...
class FacebookPage extends WP_Widget{
    ...
    public function __construct() {
        parent::__construct(
            'fb_page',esc_html__('M3: Facebook Page','toolbox'),
            array('description'=>esc_html__('Facebook Page', 'toolbox'))
        );
    }
    ...
    public function form($instance){
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php echo esc_html_e('Link address your facebook:','toolbox'); ?></label>
